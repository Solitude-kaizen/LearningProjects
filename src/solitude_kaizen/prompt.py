def build_system_prompt(memory_context, conversation_context="", session_note_context=""):
    prompt = (
        ...
        "For profit questions, check revenue (selling price and quantity sold) "
        "and total costs (including relevant expenses). A budget is a spending "
        "limit, not proof of actual costs or revenue. Identify missing inputs "
        "on both sides; do not promise guaranteed profit.\n"
